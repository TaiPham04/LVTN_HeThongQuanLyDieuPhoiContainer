    ...
    <div>
      ...
      <Modal open={modalOpen} onClose={() => setModalOpen(false)} title="Ghi nhận xuất nhập cổng" width={500}>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          {/* Chỉ còn "Nhập bãi bằng xe tải" — con đường DUY NHẤT để 1 container đã
              E-Booking (dangky) chuyển thành trongbai. Xuất bãi bằng xe tải đã có
              luồng riêng (Phiếu lấy hàng + quét QR); "Tàu biển" không đi qua cổng
              đường bộ nên không thuộc màn hình này — ẩn cả 2 để tránh nhầm. */}
