...
const MENU = [
  { path: '/kh/dashboard',      icon: 'ti-layout-dashboard', label: 'Tổng quan' },
  { path: '/kh/booking',        icon: 'ti-file-plus',        label: 'E-Booking' },
  { path: '/kh/containers',     icon: 'ti-package',          label: 'Container của tôi' },
  { path: '/kh/phieu-lay-hang', icon: 'ti-ticket',           label: 'Phiếu lấy hàng' },
  { path: '/kh/tai-xe',         icon: 'ti-truck',            label: 'Tài xế của tôi' },
];
...
export default function KhachHangLayout() {
  ...
  const tenTrang = MENU.find(m => location.pathname.startsWith(m.path))?.label || 'Tổng quan';
  ...
  return (
    <div style={s.root}>
      ...
      <aside style={s.sidebar}>
        ...
        {/* Role badge */}
        <div style={s.roleBadge}>Khách hàng</div>
