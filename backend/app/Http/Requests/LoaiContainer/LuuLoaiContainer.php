...
class LuuLoaiContainer extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'cho_phep_xep_chong' => ['required', 'boolean'],
            'tang_toi_da'        => ['nullable', 'integer', 'min:1', 'max:10'],
    ...
    public function messages(): array
    {
        return [
            ...
            'cho_phep_xep_chong.required'    => 'Vui lòng chọn loại xếp chồng.',
            'tang_toi_da.integer'            => 'Tầng tối đa phải là số nguyên.',
            'tang_toi_da.min'                => 'Tầng tối đa phải ít nhất là 1.',
            'tang_toi_da.max'                => 'Tầng tối đa không quá 10.',
